package host.plas.streamersunite.utils;
...
public class MessageUtils {
    ...
    public static String getInfoLogPrefix() {
        return colorize("&7[&3" + StreamersUnite.getInstance().getName() + "&7] &f");
    }

    public static String getErrorLogPrefix() {
        return colorize("&7[&3" + StreamersUnite.getInstance().getName() + "&7] &c");
    }

    public static String getWarningLogPrefix() {
        return colorize("&7[&3" + StreamersUnite.getInstance().getName() + "&7] &e");
    }

    public static String getDebugLogPrefix() {
        return colorize("&7[&3" + StreamersUnite.getInstance().getName() + "&7] &7[&cDEBUG&7] &b");
    }
